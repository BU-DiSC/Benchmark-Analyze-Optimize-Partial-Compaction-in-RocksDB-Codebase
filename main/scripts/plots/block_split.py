...
save_path = '/Users/weiran/BU/EDBT/Results/Final/revision/Block-Split.pdf'
data_root = '/Users/weiran/BU/Thesis/rocksdb/main/workspace/edbt_revision/block_split'
...
data_dir = data_root
myplot(data_dir, labels, sub_dirs, data_total_bytes, axs, 0, '(a)', y_start, y_end, y_ticks)
